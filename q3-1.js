...
document.getElementsByClassName("clapping-container").addEventListener("click", function(){
document.getElementsByClassName("clap").style.opacity  =   document.getElementById("clap").style.opacity*0; });
